    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title}>Home Currency</Text>
          <Text style={styles.subtitle}>
            Please select the currency you use at home. This is mandatory, as all your future expenses will be converted to this currency for your statistics.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            <Text style={styles.selectButtonText}>
              {selectedCountry ? `${selectedCountry.flag} ${selectedCountry.country}` : "Select Currency"}
            </Text>
          </Button>
